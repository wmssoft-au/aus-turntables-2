    ...
    def get_lines(self, productions):
        ...
        for product in productions.mapped('product_id'):
            ...
            res.append({
                ...
                'outsource_moves': outsource_moves,
                'total_cost': total_cost,
                'total_cost_outsource': total_cost_outsource,
                'scraps': scraps,
                'mocount': len(mos),
